...
libraries <- c(
  "shiny", "knitr", "DT", "tidyverse", "ggplot2", "caret",
  "magrittr", "rvest", "glmnet", "corrplot", "grid", "parameters",
  "performance", "randomForest", "gridExtra", "xgboost"
)
...
```{r}
# Create a subset of your data containing only the relevant variables
